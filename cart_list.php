 <!-- Masthead-->
        <header class="masthead" style="background-image: url('assets/img/food1.gif');">
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h2 class="text-uppercase text-white font-weight-bold">Cart List</h2>
                        <hr class="divider my-10" /><hr style="height:5px;border-width:0px;color:black;background-color:green">
                    </div>
                </div>
            </div>
        </header>
		<hr style="height:5px;border-width:0px;color:yellow;background-color:yellow">
	        		...
	        		<div class="card-body">
		        		<div class="row">
			        		...
			        		<div class="col-md-4">
			        			...
			        			<p class='truncate'> <b><small>Description :<?php echo $row['description'] ?></small></b></p>
			        			<p> <b><small>Price :<?php echo number_format($row['price'],2) ?></small></b></p>
